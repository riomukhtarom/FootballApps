...
class NextMatchesAdapter (private val context: Context, private val matchs: List<Match>, private val listener: (Match) -> Unit)
    : RecyclerView.Adapter<NextMatchesAdapter.MatchViewHolder>(){
